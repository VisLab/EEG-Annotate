...
outPathBase = 'D:\Research\Annotate\Kay\Data\VEP_PREP_ICA_VEP2_MARA_averagePower_ARRLSimb';
targetClasses = {'34', '35'};
...
for k = 1:length(targetClasses)
  ...
  batchClassifyARRLSimb(testPaths, trainPaths, outPath, targetClasses{k});
end
