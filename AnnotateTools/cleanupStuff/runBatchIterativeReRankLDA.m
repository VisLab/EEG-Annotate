...
%% Set the directors
trainDir = 'D:\Research\Annotate\Kyung\Data\VEP_PREP_ICA_VEP2_MARA_averagePower';
testDirBase = 'D:\Research\Annotate\Kay\Data\VEP_PREP_ICA_VEP2_MARA_averagePower_ARRLS_Positive';
outPathBase = 'D:\Research\Annotate\Kay\Data\VEP_PREP_ICA_VEP2_MARA_averagePower_ARRLS_Positive_LDAReranked';
targetClasses = {'34', '35'};
targetClassifier = 'LDA';
params = struct();
...
for k = 1%:length(targetClasses)
    ...
    for n = 1%:length(testPaths)
       outFileNames = batchClassify(testPaths(n), trainPaths, ...
                      outPath, targetClasses{k}, targetClassifier, params);
