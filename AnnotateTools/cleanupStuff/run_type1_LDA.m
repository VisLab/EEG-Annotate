...
pathOutput = '.\output\type1_LDA_34';  % 'type1_LDA_34', 'type1_LDA_35'
...
%   Using the LDA classifier (LDA: Lineary Discriminat Analysis)
%   Note:
%       It stores estimated classification scores using the scoreData structure. 
%       scoreData structure has six fields.
...
batch_plot_aligned_window_scores([pathTemp filesep 'VEP_PREP_ICA_VEP2_MARA_averagePower_LDA_' trainTargetClass], ...
             'outPath', [pathOutput filesep 'report'], ...
