function scoreData = rerankARRLSimb(dataPathTest, dataPathTrain, ...
...
%% Load the data
    dataTest = load(dataPathTest);
    [trainSamples, trainLabels] = getTrainingData(dataPathTrain, targetClass);
    scoreData.testFileName =  dataPathTest;
    scoreData.trainFileName = dataPathTrain;
    ...
    [finalScores, finalCutoff, initProbs, initCutoff, trainScores] = ...
        ...
        trainLabels, pseudoLabels, optionARRLS, optionIMB);   
    ...
    fprintf('ARRLSimb done train:%s\n       test: %s\n', dataPathTrain, dataPathTest);  
end
