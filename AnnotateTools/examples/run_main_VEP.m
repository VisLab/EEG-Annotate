...
batch_preprocess_PREP('Z:\Data 3\VEP\VEP_BIOSIMI', ...
             ...
             'keepFiltered', false);
batch_preprocess_VEP_exclusive('D:\temp\PREP', ...
             'outPath', 'D:\temp\VEP2', ...
             'boundary', 1);
batch_preprocess_cleanASR('D:\temp\VEP2', ...
             'outPath', 'D:\temp\cleanASR', ...
             'burstCriterion', 20);
...
batch_feature_averagePower('D:\temp\cleanASR', ...
             'outPath', 'D:\temp\averagePower', ...
...
batch_classify_ARRLSs('D:\temp\averagePower', ...  % test data
             'D:\temp\averagePower', ...          % training data
             'outPath', 'D:\temp\scoreARRLS', ...
             'targetClass', '34', ...
             'p', 10, ...
             'sigma', 0.1, ...
             'lambda', 10.0, ...
...
batch_annotation('D:\temp\scoreARRLS', ...
             'outPath', '.\output\annotScore', ...
             'excludeSelf', true, ...
             'fHighRecall', true, ...
             'position', 8, ...
...
batch_report_recall('.\output\annotScore', ...
