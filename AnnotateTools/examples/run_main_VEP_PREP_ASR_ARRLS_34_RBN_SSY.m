...
pathTemp = 'D:\temp';
pathOutput = '.\output_PREP_ASR_averagePower_ARRLS_34_RBN_SSY';
trainTargetClass = '34';
...
batch_preprocess_VEP_exclusive([pathTemp filesep 'PREP'], ...
             'outPath', [pathTemp filesep 'PREP_VEP2'], ...
             'boundary', 1);
batch_preprocess_cleanASR([pathTemp filesep 'PREP_VEP2'], ...
             'outPath', [pathTemp filesep 'PREP_VEP2_ASR'], ...
             'burstCriterion', 20);
...
batch_feature_averagePower([pathTemp filesep 'PREP_VEP2_ASR'], ...
             'outPath', [pathTemp filesep 'PREP_VEP2_ASR_averagePower'], ...
...
batch_classify_ARRLSs([pathTemp filesep 'PREP_VEP2_ASR_averagePower'], ...  % test data
             [pathTemp filesep 'PREP_VEP2_ASR_averagePower'], ...          % training data
             'outPath', [pathTemp filesep 'PREP_VEP2_ASR_averagePower_scoreARRLS_' trainTargetClass], ...
...
batch_annotation([pathTemp filesep 'PREP_VEP2_ASR_averagePower_scoreARRLS_' trainTargetClass], ...
