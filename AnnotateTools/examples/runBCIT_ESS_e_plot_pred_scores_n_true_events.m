...
scoreIn = 'Z:\Data 4\annotate\BCIT\Level2_256Hz_ASR_featureA_scoreA';    % annotated samples
plotOut = 'Z:\Data 4\annotate\BCIT\Level2_256Hz_ASR_featureA_scoreA_results';    
...
for t=1:length(testNames)
    ...
    for testSubjID=1:length(filenames)
        ...
        plotEachOut = [plotOut filesep 'plot_pred_scores_n_true_events' filesep testName filesep 'session' filesep sessionNumbers{testSubjID}];
