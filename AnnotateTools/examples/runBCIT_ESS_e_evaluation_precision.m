...
scoreIn = 'Z:\Data 3\BCIT_ESS\Level2_256Hz_HP_featureA_scoreA\';
resultOut = 'Z:\Data 3\BCIT_ESS\Level2_256Hz_HP_featureA_scoreA_results\';
...
for t=1:length(testNames)
    ...
    averagePrecisions = zeros(maxAnnotation, testsetNumb, length(t_tolerance)); % avrage precisions
    ...
    save([resultDir filesep saveName '.mat'], 'averagePrecisions', '-v7.3');
    disp(squeeze(mean(averagePrecisions(1:10, :, :), 2)));   % print out results
end