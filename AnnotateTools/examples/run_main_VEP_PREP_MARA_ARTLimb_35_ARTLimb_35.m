...
pathTemp = 'D:\temp';
pathOutput = '.\output_PREP_MARA_averagePowe_ARTLimb_35';
trainTargetClass = '35';
testTargetClasses = {'35'};
reRankMethod = 'rrIterative';  % 'rrIterative'
...
% 
% %% 5)Re-ranking (re-classification)
% batch_re_classify_ARTLimb([pathTemp filesep 'PREP_ICA_MARA_averagePower'], ...  % test data
%              [pathTemp filesep 'PREP_ICA_MARA_averagePower_ARTLimb_' trainTargetClass], ... % test data init score
%              [pathTemp filesep 'PREP_ICA_MARA_averagePower'], ...          % training data 
%              [pathTemp filesep 'PREP_ICA_MARA_averagePower_ARTLimb_' trainTargetClass], ... % training data init score
%              'outPath', [pathTemp filesep 'PREP_ICA_MARA_averagePower_ARTLimb_' trainTargetClass '_ARTLimb_'  trainTargetClass '_' reRankMethod], ...
%              'targetClass', trainTargetClass, ...
%              'ARRLS_p', 10, ...     % ARRLS parameters
%              'ARRLS_sigma', 0.1, ...
%              'ARRLS_lambda', 10.0, ...
...
%          
% batch_annotation([pathTemp filesep 'PREP_ICA_MARA_averagePower_ARTLimb_' trainTargetClass '_ARTLimb_'  trainTargetClass '_' reRankMethod], ...
%              'outPath', [pathOutput filesep 'annotScore_rerank_' reRankMethod], ...
%              'excludeSelf', true, ...
%              'adaptiveCutoff', true, ...
%              'rescaleBeforeCombining', true, ...
%              'position', 8, ...
...
% batch_report_RAP([pathOutput filesep 'annotScore_rerank'], ...
%              'outPath', [pathOutput filesep 'report_rerank'], ...
%              'targetClasses', testTargetClasses, ...   % hit if it is any one of these class
%              'timinigTolerances', 0:7); 
% batch_report_recall([pathOutput filesep 'annotScore_rerank'], ...
%              'outPath', [pathOutput filesep 'report_rerank'], ...
%              'targetClasses', testTargetClasses, ...   % hit if it is any one of these class
%              'timinigTolerances', 0:7, ...
%              'retrieveNumbs', 100:100:500); 
% batch_report_precision([pathOutput filesep 'annotScore_rerank'], ...
%              'outPath', [pathOutput filesep 'report_rerank'], ...
%              'targetClasses', testTargetClasses, ...   % hit if it is any one of these class
%              'timinigTolerances', 0:7, ...
%              'maxAnnotation', 100); 
% batch_plot_allPredictions([pathOutput filesep 'annotScore_rerank'], ...
%              'outPath', [pathOutput filesep 'report_rerank' filesep 'plotAllScores'], ...
...
%              'fBinary', false); 
batch_plot_true_in_wing_rerank([pathOutput filesep 'annotScore'], ...
             [pathOutput filesep 'annotScore_rerank_' reRankMethod], ...   
             'outPath', [pathOutput filesep 'report_rerank_' reRankMethod filesep 'plotTrueWing_rerank'], ...
             'timingTolerances', 3, ...
             'offPast', 32, ...
             'offFuture', 32, ...
             'titleStr', ['Foe_re_ranking_' reRankMethod]);   % number of sub-window smaples in each window
