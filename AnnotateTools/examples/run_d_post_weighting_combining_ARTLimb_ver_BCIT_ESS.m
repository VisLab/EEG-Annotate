...
scoreBase = 'Z:\Data 4\annotate\BCIT\BE_256Hz_II_MARA_fAP_trMARA\sAi_35_1_6_110_6\';	% path to estimated scores
...
for t=1:length(testNames)
    ...
    for testSubjID=1:50 %1:length(filenames)  %1:length(filenames)
