...
for t=1:length(testNames)
    ...
    for testSubjID=1:length(filenames)
        ...
        plotEachOut = [plotOut filesep 'sortScore_events' num2str(eventNumb) '_tolerance' num2str(timingTolerance) '_offset_' num2str(offPast) '_' num2str(offFuture) filesep testName filesep 'session' filesep sessionNumbers{testSubjID}];
