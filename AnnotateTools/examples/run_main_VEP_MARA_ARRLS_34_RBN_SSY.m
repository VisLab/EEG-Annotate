...
% 0) Parameters
pathIn = 'Z:\Data 3\VEP\VEP_PrepClean_Infomax';   % it is already PREP and ICA processed.
pathTemp = 'D:\temp';
pathOutput = '.\output_PREP_MARA_averagePowe_ARRLS_34_SSY';
trainTargetClass = '34';
...
batch_classify_ARRLSs([pathTemp filesep 'PREP_ICA_MARA_averagePower'], ...  % test data
             [pathTemp filesep 'PREP_ICA_MARA_averagePower'], ...          % training data
             'outPath', [pathTemp filesep 'PREP_ICA_MARA_averagePower_scoreARRLS_' trainTargetClass], ...
...
batch_annotation([pathTemp filesep 'PREP_ICA_MARA_averagePower_scoreARRLS_' trainTargetClass], ...
