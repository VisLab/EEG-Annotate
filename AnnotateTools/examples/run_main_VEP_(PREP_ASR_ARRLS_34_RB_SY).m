...
% 0) Parameters
pathRaw = 'Z:\Data 3\VEP\VEP_BIOSIMI';
pathTemp = 'D:\temp';
pathOutput = '.\output';
trainTargetClass = '34';
...
batch_preprocess_PREP(pathRaw, ...
             'outPath', [pathTemp filesep 'PREP'], ...
             ...
             'keepFiltered', false);
batch_preprocess_VEP_exclusive([pathTemp filesep 'PREP'], ...
             'outPath', [pathTemp filesep 'VEP2'], ...
             'boundary', 1);
batch_preprocess_cleanASR([pathTemp filesep 'VEP2'], ...
             'outPath', [pathTemp filesep 'cleanASR'], ...
             'burstCriterion', 20);
...
batch_feature_averagePower([pathTemp filesep 'cleanASR'], ...
             'outPath', [pathTemp filesep 'averagePower'], ...
...
batch_classify_ARRLSs([pathTemp filesep 'averagePower'], ...  % test data
             [pathTemp filesep 'averagePower'], ...          % training data
             'outPath', [pathTemp filesep 'scoreARRLS_' trainTargetClass], ...
...
batch_annotation([pathTemp filesep 'scoreARRLS_' trainTargetClass], ...
             'outPath', [pathOutput '_' trainTargetClass filesep 'annotScore'], ...
             'excludeSelf', true, ...
             'fHighRecall', true, ...
             'position', 8, ...
...
batch_report_RAP([pathOutput filesep 'annotScore_' trainTargetClass], ...
             'outPath', [pathOutput '_' trainTargetClass filesep 'report'], ...
             'targetClasses', testTargetClasses, ...   % hit if it is any one of these class
             'timinigTolerances', 0:7); 
batch_report_recall([pathOutput filesep 'annotScore_' trainTargetClass], ...
             'outPath', [pathOutput '_' trainTargetClass filesep 'report'], ...
             'targetClasses', testTargetClasses, ...   % hit if it is any one of these class
             'timinigTolerances', 0:7, ...
             'retrieveNumbs', 100:100:500); 
batch_report_precision([pathOutput filesep 'annotScore_' trainTargetClass], ...
             'outPath', [pathOutput '_' trainTargetClass filesep 'report'], ...
             'targetClasses', testTargetClasses, ...   % hit if it is any one of these class
             'timinigTolerances', 0:7, ...
             'maxAnnotation', 100); 
