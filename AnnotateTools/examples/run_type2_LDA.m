...
batch_classify_LDA([pathTemp filesep 'BCIT_ESS_PREP_ICA_BCIT2_MARA_averagePower'], ...  % test data
             [pathTemp filesep 'VEP_PREP_ICA_VEP2_MARA_averagePower'], ...          % training data
             'outPath', [pathTemp filesep 'BCIT_ESS_PREP_ICA_BCIT2_MARA_averagePower_LDA_' trainTargetClass], ...
...
batch_annotation([pathTemp filesep 'BCIT_ESS_PREP_ICA_BCIT2_MARA_averagePower_LDA_' trainTargetClass], ...
