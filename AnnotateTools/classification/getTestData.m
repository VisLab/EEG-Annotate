...
%
function [samples, labelsOriginal, excludeIdx] = getTestData(dataPath, fileName)
    ...
    excludeIdx = data.mask.indexOverlapBoundary;

    samples = samples(:, excludeIdx == 0);      % the size of samples and labels could be different.
end