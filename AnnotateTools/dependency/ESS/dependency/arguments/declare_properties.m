...
% (and possibly other functions in the future), to support improved integration of these functions 
...
%                'name': specify the GUI/human-readable name of this function
